...
Read full introduction to the library in [the documentation](https://github.com/yandex/city-services-pub/blob/main/yx_scope/docs/introduction.md#in-the-widget-tree).
